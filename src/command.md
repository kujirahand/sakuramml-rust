...
| コマンド | 説明    |
|---------|--------|
| 全音符 | undefined(="l1" // 全音符を基本音符にする) |
| 二分音符 | undefined(="l2" // 二分音符を基本音符にする) |
| 四分音符 | undefined(="l4" // 四分音符を基本音符にする) |
| 八分音符 | undefined(="l8" // 八分音符を基本音符にする) |
| 十六音符 | undefined(="l16" // 十六音符を基本音符にする) |
| 付点四分音符 | undefined(="l4." // 付点四分音符を基本音符にする) |
